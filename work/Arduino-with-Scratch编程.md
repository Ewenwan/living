...
[arduino 各种传感器程序 ](https://github.com/Ewenwan/learn-sensors)
...
### 物联网专题:什么是Thingspeak 
[物联网IoT教程](http://learn.kittenbot.cn/zh_CN/latest/IoT/index.html)
...
# Arduino
[参考](http://learn.kittenbot.cn/zh_CN/latest/arduino/index.html)

在Kittenblock中享受你的Arduino编程吧

    1. 01Arduino图形化入门编程套件
    1.1. 产品名称：
    1.2. 配送清单：
    1.3. 产品简介：
    1.4. 产品特色：
...
# Microbit进阶教程
[参考](http://learn.kittenbot.cn/zh_CN/latest/microbitadvanced/index.html)

    1. MICROBIT盘符变为MAINTENANCE的原因及恢复方法
    2. Microbit底层固件更新
    2.1. 查看手中Microbit底层固件版本的方法
    2.2. 更新底层固件方法
    3. Microbit串口驱动安装
    3.1. 串口安装方式
    4. 让Microbit听说英文
    4.1. 英文语音识别功能使用方法
    4.2. Microbit开口说英文功能操作方法
    4.3. 综合示例
    5. 四位时钟数码管TM1637
    5.1. 连接
    5.2. 编程前准备
    ...
    7.10. 广播事件
    7.11. 奖杯触碰停止事件
    7.12. 改造程序，让Microbi控制王校长
    7.13. 选择王校长这个角色
    8. 微信小程序：Microbit喵咪咪
    8.1. 使用步骤
    8.2. 小程序控制功能
    9. 喵星人不一样的解读——MIT Scratch 3.0
    9.1. Scratch3.0到底更新了什么
    9.2. 体验Scratch3.0的Microbit编程
    9.3. 感受与体会
    9.4. 官方Scratch3.0的问与答，你所关心的问题
    9.5. Scratch连接Microbit的“正确打开方式”
